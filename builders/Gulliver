...
rm -r "${PROJECTS_FOLDER}/iOS_Builds/${PROJECT_NAME}UI.framework"
cp -r "${PROJECT_DIR}/iOS Framework/${PROJECT_NAME}UI.framework" "${PROJECTS_FOLDER}/iOS_Builds/${PROJECT_NAME}UI.framework"
